...
# SMF COMMENT: Great use of sprintf()!
...
# SMF COMMENT: previous line gives the index, NOT the year
...
# SMF COMMENT: Excellent job!  Nice use of function and list to store all the data.
# SMF COMMENT:  One downside to the list is that it isn't a rectangular data object, which
# SMF COMMENT: would make it potentially hard to write the data to files.  Can you think 
# SMF COMMENT: of a way to make rectangular objects?  Just food for thought ... 
